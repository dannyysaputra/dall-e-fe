  ...
  const generateImage = async () => {
    if (form.prompt) {
      try {
        ...
        setForm({ ...form, photo: `data:image/jpege;base64,${data.photo}` })
      } catch (error) {
        alert(error);
      } finally {
    ...
    <section className="max-w-7xl mx-auto">
     ...
     <form className='mt-16 max-w-3xl' onSubmit={handleSubmit}>
        ...
        <div className="mt-10">
          ...
          <button
            type='submit'
            className='mt-4 text-white bg-[#6469ff] font-medium rounded-md text-sm w-full sm:w-auto px-5 py-2.5 text-center'
          >
